...
function recMismatch(cat,cur,rec){if(rec==null)return false;if(cat&&cat.t==="bool")return isOn(cur)!==isOn(rec);return cur!==rec;}
    ...
    function ModelManagerPanel() {
      ...
      function markDirty() {
        ...
        const btn = root.querySelector("#mmBtnSave"); if (btn) { btn.disabled = false; btn.textContent = "● 保存"; }
      }
      ...
      function onRootClick(ev) {
        ...
        else if (act === "save") { setMoreOpen(false); doSave(); }
      ...
      function onRootKey(ev) { if (ev.key === "Escape" && moreOpen) setMoreOpen(false); }
      ...
      return e("div", { ref: rootRef, className: "mm-root", onClick: onRootClick, onInput: onRootInput, onChange: onRootChange, onKeyDown: onRootKey },
        e("style", null, CSS),
        /* 顶栏 */
